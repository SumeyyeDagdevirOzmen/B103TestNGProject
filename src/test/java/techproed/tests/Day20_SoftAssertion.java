...
public class Day20_SoftAssertion {
    ...
    public void softAssertTest(){
        ...
        softAssert.assertEquals(2,5);//2, 5 e esit degildir FAIL olacak
        ...
        softAssert.assertAll();//En sonda kullanmamiz sart. PASS yada FAIL olarak assertion lari isaretler
