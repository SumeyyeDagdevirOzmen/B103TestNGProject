...
public class ExcelUtils {
    ...
    private String path;
    //Constructor. Ne zaman cagrilir? Amaci nedir? Excel pathi ve sayfaya ulasmak icin kullanilir.
    public ExcelUtils(String path, String sheetName) {//This Constructor is to open and access the excel file
        ...
        try {
            ...
            Assert.assertNotNull(workSheet, "Worksheet: \"" + sheetName + "\" was not found\n");//Dosya bulunamadiginda bu mesaji ver demktir.Vermis oldugun dosya yolu veya sayfa ismi yanlis demektir.
        } catch (Exception e) {
    ...
    //Exceldeki verileri List olarak almamizi saglar, verileri List olarak bize return eder.
    //Exceldeki verileri Java Test sinifinda kullanmak icin bu methodu kullanacagiz.
    ...
    //Herbir hucredeki datayi almak icin kullaniriz.
    ...
    //===============Exceldeki datalari 2 boyutlu array seklinde alir Baslik dahil tum datalari alir==================
    ...
    //=====================Sutun isimlerini(headers) return eder================================================
    ...
    //=====================3 parametre alir.Deger,Satir,Sutun girildiginde o satir ve sutuna girilen veriyi yazdirir.================
    ...
    // Bu method ustteki methodla birlikte calisir,Overload eder. Parametreleri farklidir
    ...
    //====================Exceldeki tum datalari basliksiz olarak 2 boyutlu array seklinde return eder. Biz bu methodu data provider'da kullanicagiz.
